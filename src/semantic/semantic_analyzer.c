...
//     (void)symbol_table_exists(symbol_table, declaration->identifier, &valid_identifier);
//     if (valid_identifier)
//         return add_redeclaration_error(error_list, current_error, declaration->identifier);
    
//     err = symbol_table_add(symbol_table, declaration->identifier);
//     return err;
// }
...
//     {
//         bool valid_identifier = false;
//         (void)symbol_table_exists(symbol_table, expression->identifier, &valid_identifier);
//         if (!valid_identifier)
